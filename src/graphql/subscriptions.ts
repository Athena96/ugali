...
`;
export const onCreateSpendingBudget = /* GraphQL */ `
  subscription OnCreateSpendingBudget {
...
`;
export const onUpdateSpendingBudget = /* GraphQL */ `
  subscription OnUpdateSpendingBudget {
...
`;
export const onDeleteSpendingBudget = /* GraphQL */ `
  subscription OnDeleteSpendingBudget {
