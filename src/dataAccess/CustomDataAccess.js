...
AWS.config.accessKeyId = "AKIASQ7R57SOYZ74ULFY";//process.env.REACT_APP_ACCESS_KEY;
AWS.config.secretAccessKey = "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"; //process.env.REACT_APP_SEC_ACCESS_KEY;
